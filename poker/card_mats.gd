...
@export var heart_mats: Dictionary[int, Texture2D]
@export var spade_mats: Dictionary[int, Texture2D]
@export var diamond_mats: Dictionary[int, Texture2D]
@export var club_mats: Dictionary[int, Texture2D]
